...
在内存中的结构是：![](images/7.1\_fig7.1.png)
...
示例 7.1 [for\_arrays.go](examples/chapter\_7/for\_arrays.go)
...
示例 7.2 [pointer\_array.go](examples/chapter\_7/pointer\_array.go):
...
练习7.1：[array\_value.go](examples/chapter\_7/array\_value.go):

证明当数组赋值时，发生了数组内存拷贝。

练习7.2：[for\_array.go](examples/chapter\_7/for\_array.go):

写一个循环并用下标给数组赋值（从 0 到 15）并且将数组打印在屏幕上。

练习7.3：[fibonacci\_array.go](examples/chapter\_7/fibonacci\_array.go):
...
示例 7.3 [array\_literals.go](examples/chapter\_7/array\_literals.go)
...
示例 7.4 [pointer\_array2.go](examples/chapter\_7/pointer\_array2.go)
...
示例 7.5 [multidim\_array.go](examples/chapter\_7/multidim\_array.go)
...
示例 7.6 [array\_sum.go](examples/chapter\_7/array\_sum.go)
