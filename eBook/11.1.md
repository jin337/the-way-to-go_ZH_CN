...
示例 11.1 [interfaces.go](examples/chapter\_11/interfaces.go)：
...
示例 11.2 [interfaces\_poly.go](examples/chapter\_11/interfaces\_poly.go)：
...
示例 11.3 [valuable.go](examples/chapter\_11/valuable.go)：
...
**练习 11.1** [simple\_interface.go](exercises/chapter\_11/simple\_interface.go)：
...
**练习 11.2** [interfaces\_poly2.go](exercises/chapter\_11/interfaces\_poly2.go)：

a) 扩展 [interfaces\_poly.go](exercises/chapter\_11/interfaces\_poly.go) 中的例子，添加一个 `Circle` 类型
